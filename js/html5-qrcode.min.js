function getLazarSoftScanner() {
    ...
    function r(e, t, n, r, i, a) {
        (this.versionNumber = e), (this.alignmentPatternCenters = t), (this.ecBlocks = new Array(n, r, i, a));
        for (var o = 0, s = n.ECCodewordsPerBlock, h = n.getECBlocks(), w = 0; w < h.length; w++) {
            var f = h[w];
        ...
        (this.totalCodewords = o),
            ...
            (this.buildFunctionPattern = function () {
                ...
                for (var n = this.alignmentPatternCenters.length, r = 0; r < n; r++)
                    for (var i = this.alignmentPatternCenters[r] - 2, a = 0; a < n; a++) (0 == r && (0 == a || a == n - 1)) || (r == n - 1 && 0 == a) || t.setRegion(this.alignmentPatternCenters[a] - 2, i, 5, 5);
    ...
    function i(e, t, n, r, a, o, s, h, w) {
        (this.a11 = e),
            ...
            (this.transformPoints1 = function (e) {
                for (var t = e.length, n = this.a11, r = this.a12, i = this.a13, a = this.a21, o = this.a22, s = this.a23, h = this.a31, w = this.a32, f = this.a33, u = 0; u < t; u += 2) {
                    var d = e[u],
                        l = e[u + 1],
                        c = i * d + s * l + f;
                    (e[u] = (n * d + a * l + h) / c), (e[u + 1] = (r * d + o * l + w) / c);
                }
            }),
            (this.transformPoints2 = function (e, t) {
                for (var n = e.length, r = 0; r < n; r++) {
                    ...
                    (e[r] = (this.a11 * i + this.a21 * a + this.a31) / o), (t[r] = (this.a12 * i + this.a22 * a + this.a32) / o);
                }
            }),
    ...
    function o(t) {
        (this.image = t),
            ...
            (this.sizeOfBlackWhiteBlackRun = function (e, t, n, r) {
                ...
                for (var o = Math.abs(n - e), s = Math.abs(r - t), h = -o >> 1, w = t < r ? 1 : -1, f = e < n ? 1 : -1, u = 0, d = e, l = t; d != n; d += f) {
                    var c = i ? l : d,
                        g = i ? d : l;
                    if ((1 == u ? this.image[c + g * A.width] && u++ : this.image[c + g * A.width] || u++, 3 == u)) {
                        var v = d - e,
                            m = l - t;
            ...
            (this.sizeOfBlackWhiteBlackRunBothWays = function (e, t, n, r) {
                var i = this.sizeOfBlackWhiteBlackRun(e, t, n, r),
                    a = 1,
                    o = e - (n - e);
                o < 0 ? ((a = e / (e - o)), (o = 0)) : o >= A.width && ((a = (A.width - 1 - e) / (o - e)), (o = A.width - 1));
                var s = Math.floor(t - (r - t) * a);
                return (a = 1), s < 0 ? ((a = t / (t - s)), (s = 0)) : s >= A.height && ((a = (A.height - 1 - t) / (s - t)), (s = A.height - 1)), (o = Math.floor(e + (o - e) * a)), (i += this.sizeOfBlackWhiteBlackRun(e, t, o, s)) - 1;
            }),
            ...
            (this.findAlignmentInRegion = function (e, t, n, r) {
                ...
                return new F(this.image, a, s, o - a, h - s, e, this.resultPointCallback).find();
            }),
            (this.createTransform = function (e, t, n, r, a) {
                var o,
                    ...
                    w,
                    f = a - 3.5;
                return null != r ? ((o = r.X), (s = r.Y), (h = w = f - 3)) : ((o = t.X - e.X + n.X), (s = t.Y - e.Y + n.Y), (h = w = f)), i.quadrilateralToQuadrilateral(3.5, 3.5, f, 3.5, h, w, 3.5, f, e.X, e.Y, t.X, t.Y, o, s, n.X, n.Y);
            }),
            ...
            (this.processFinderPatternInfo = function (e) {
                ...
                if (h.AlignmentPatternCenters.length > 0)
                    for (var u = n.X - t.X + i.X, d = n.Y - t.Y + i.Y, l = 1 - 3 / w, c = Math.floor(t.X + l * (u - t.X)), g = Math.floor(t.Y + l * (d - t.Y)), v = 4; v <= 16; v <<= 1) {
                        f = this.findAlignmentInRegion(o, c, g, v);
                        break;
                    }
                var m = this.createTransform(t, n, i, f, s);
                return new a(this.sampleGrid(this.image, m, s), null == f ? new Array(i, t, n) : new Array(i, t, n, f));
            }),
    ...
    (e.checkAndNudgePoints = function (e, t) {
        for (var n = A.width, r = A.height, i = !0, a = 0; a < t.length && i; a += 2) {
            var o = Math.floor(t[a]),
                s = Math.floor(t[a + 1]);
            if (o < -1 || o > n || s < -1 || s > r) throw "Error.checkAndNudgePoints ";
            (i = !1), -1 == o ? ((t[a] = 0), (i = !0)) : o == n && ((t[a] = n - 1), (i = !0)), -1 == s ? ((t[a + 1] = 0), (i = !0)) : s == r && ((t[a + 1] = r - 1), (i = !0));
        }
        i = !0;
        ...
        (e.sampleGrid3 = function (t, n, r) {
            for (var i = new v(n), a = new Array(n << 1), o = 0; o < n; o++) {
                for (var s = a.length, h = o + 0.5, w = 0; w < s; w += 2) (a[w] = 0.5 + (w >> 1)), (a[w + 1] = h);
                r.transformPoints1(a), e.checkAndNudgePoints(t, a);
                try {
                    for (w = 0; w < s; w += 2) {
                        t[Math.floor(a[w]) + A.width * Math.floor(a[w + 1])] && i.set_Renamed(w >> 1, o);
                    }
                } catch (e) {
        ...
        (e.sampleGridx = function (t, n, r, a, o, s, h, w, f, u, d, l, c, g, v, m, b, y) {
            var C = i.quadrilateralToQuadrilateral(r, a, o, s, h, w, f, u, d, l, c, g, v, m, b, y);
        ...
        (r.VERSIONS = new Array(
            new r(1, new Array(), new n(7, new t(1, 19)), new n(10, new t(1, 16)), new n(13, new t(1, 13)), new n(17, new t(1, 9))),
            new r(2, new Array(6, 18), new n(10, new t(1, 34)), new n(16, new t(1, 28)), new n(22, new t(1, 22)), new n(28, new t(1, 16))),
            new r(3, new Array(6, 22), new n(15, new t(1, 55)), new n(26, new t(1, 44)), new n(18, new t(2, 17)), new n(22, new t(2, 13))),
            new r(4, new Array(6, 26), new n(20, new t(1, 80)), new n(18, new t(2, 32)), new n(26, new t(2, 24)), new n(16, new t(4, 9))),
            new r(5, new Array(6, 30), new n(26, new t(1, 108)), new n(24, new t(2, 43)), new n(18, new t(2, 15), new t(2, 16)), new n(22, new t(2, 11), new t(2, 12))),
            new r(6, new Array(6, 34), new n(18, new t(2, 68)), new n(16, new t(4, 27)), new n(24, new t(4, 19)), new n(28, new t(4, 15))),
            new r(7, new Array(6, 22, 38), new n(20, new t(2, 78)), new n(18, new t(4, 31)), new n(18, new t(2, 14), new t(4, 15)), new n(26, new t(4, 13), new t(1, 14))),
            new r(8, new Array(6, 24, 42), new n(24, new t(2, 97)), new n(22, new t(2, 38), new t(2, 39)), new n(22, new t(4, 18), new t(2, 19)), new n(26, new t(4, 14), new t(2, 15))),
            new r(9, new Array(6, 26, 46), new n(30, new t(2, 116)), new n(22, new t(3, 36), new t(2, 37)), new n(20, new t(4, 16), new t(4, 17)), new n(24, new t(4, 12), new t(4, 13))),
            new r(10, new Array(6, 28, 50), new n(18, new t(2, 68), new t(2, 69)), new n(26, new t(4, 43), new t(1, 44)), new n(24, new t(6, 19), new t(2, 20)), new n(28, new t(6, 15), new t(2, 16))),
            new r(11, new Array(6, 30, 54), new n(20, new t(4, 81)), new n(30, new t(1, 50), new t(4, 51)), new n(28, new t(4, 22), new t(4, 23)), new n(24, new t(3, 12), new t(8, 13))),
            new r(12, new Array(6, 32, 58), new n(24, new t(2, 92), new t(2, 93)), new n(22, new t(6, 36), new t(2, 37)), new n(26, new t(4, 20), new t(6, 21)), new n(28, new t(7, 14), new t(4, 15))),
            new r(13, new Array(6, 34, 62), new n(26, new t(4, 107)), new n(22, new t(8, 37), new t(1, 38)), new n(24, new t(8, 20), new t(4, 21)), new n(22, new t(12, 11), new t(4, 12))),
            new r(14, new Array(6, 26, 46, 66), new n(30, new t(3, 115), new t(1, 116)), new n(24, new t(4, 40), new t(5, 41)), new n(20, new t(11, 16), new t(5, 17)), new n(24, new t(11, 12), new t(5, 13))),
            new r(15, new Array(6, 26, 48, 70), new n(22, new t(5, 87), new t(1, 88)), new n(24, new t(5, 41), new t(5, 42)), new n(30, new t(5, 24), new t(7, 25)), new n(24, new t(11, 12), new t(7, 13))),
            new r(16, new Array(6, 26, 50, 74), new n(24, new t(5, 98), new t(1, 99)), new n(28, new t(7, 45), new t(3, 46)), new n(24, new t(15, 19), new t(2, 20)), new n(30, new t(3, 15), new t(13, 16))),
            new r(17, new Array(6, 30, 54, 78), new n(28, new t(1, 107), new t(5, 108)), new n(28, new t(10, 46), new t(1, 47)), new n(28, new t(1, 22), new t(15, 23)), new n(28, new t(2, 14), new t(17, 15))),
            new r(18, new Array(6, 30, 56, 82), new n(30, new t(5, 120), new t(1, 121)), new n(26, new t(9, 43), new t(4, 44)), new n(28, new t(17, 22), new t(1, 23)), new n(28, new t(2, 14), new t(19, 15))),
            new r(19, new Array(6, 30, 58, 86), new n(28, new t(3, 113), new t(4, 114)), new n(26, new t(3, 44), new t(11, 45)), new n(26, new t(17, 21), new t(4, 22)), new n(26, new t(9, 13), new t(16, 14))),
            new r(20, new Array(6, 34, 62, 90), new n(28, new t(3, 107), new t(5, 108)), new n(26, new t(3, 41), new t(13, 42)), new n(30, new t(15, 24), new t(5, 25)), new n(28, new t(15, 15), new t(10, 16))),
            new r(21, new Array(6, 28, 50, 72, 94), new n(28, new t(4, 116), new t(4, 117)), new n(26, new t(17, 42)), new n(28, new t(17, 22), new t(6, 23)), new n(30, new t(19, 16), new t(6, 17))),
            new r(22, new Array(6, 26, 50, 74, 98), new n(28, new t(2, 111), new t(7, 112)), new n(28, new t(17, 46)), new n(30, new t(7, 24), new t(16, 25)), new n(24, new t(34, 13))),
            new r(23, new Array(6, 30, 54, 74, 102), new n(30, new t(4, 121), new t(5, 122)), new n(28, new t(4, 47), new t(14, 48)), new n(30, new t(11, 24), new t(14, 25)), new n(30, new t(16, 15), new t(14, 16))),
            new r(24, new Array(6, 28, 54, 80, 106), new n(30, new t(6, 117), new t(4, 118)), new n(28, new t(6, 45), new t(14, 46)), new n(30, new t(11, 24), new t(16, 25)), new n(30, new t(30, 16), new t(2, 17))),
            new r(25, new Array(6, 32, 58, 84, 110), new n(26, new t(8, 106), new t(4, 107)), new n(28, new t(8, 47), new t(13, 48)), new n(30, new t(7, 24), new t(22, 25)), new n(30, new t(22, 15), new t(13, 16))),
            new r(26, new Array(6, 30, 58, 86, 114), new n(28, new t(10, 114), new t(2, 115)), new n(28, new t(19, 46), new t(4, 47)), new n(28, new t(28, 22), new t(6, 23)), new n(30, new t(33, 16), new t(4, 17))),
            new r(27, new Array(6, 34, 62, 90, 118), new n(30, new t(8, 122), new t(4, 123)), new n(28, new t(22, 45), new t(3, 46)), new n(30, new t(8, 23), new t(26, 24)), new n(30, new t(12, 15), new t(28, 16))),
            new r(28, new Array(6, 26, 50, 74, 98, 122), new n(30, new t(3, 117), new t(10, 118)), new n(28, new t(3, 45), new t(23, 46)), new n(30, new t(4, 24), new t(31, 25)), new n(30, new t(11, 15), new t(31, 16))),
            new r(29, new Array(6, 30, 54, 78, 102, 126), new n(30, new t(7, 116), new t(7, 117)), new n(28, new t(21, 45), new t(7, 46)), new n(30, new t(1, 23), new t(37, 24)), new n(30, new t(19, 15), new t(26, 16))),
            new r(30, new Array(6, 26, 52, 78, 104, 130), new n(30, new t(5, 115), new t(10, 116)), new n(28, new t(19, 47), new t(10, 48)), new n(30, new t(15, 24), new t(25, 25)), new n(30, new t(23, 15), new t(25, 16))),
            new r(31, new Array(6, 30, 56, 82, 108, 134), new n(30, new t(13, 115), new t(3, 116)), new n(28, new t(2, 46), new t(29, 47)), new n(30, new t(42, 24), new t(1, 25)), new n(30, new t(23, 15), new t(28, 16))),
            new r(32, new Array(6, 34, 60, 86, 112, 138), new n(30, new t(17, 115)), new n(28, new t(10, 46), new t(23, 47)), new n(30, new t(10, 24), new t(35, 25)), new n(30, new t(19, 15), new t(35, 16))),
            new r(33, new Array(6, 30, 58, 86, 114, 142), new n(30, new t(17, 115), new t(1, 116)), new n(28, new t(14, 46), new t(21, 47)), new n(30, new t(29, 24), new t(19, 25)), new n(30, new t(11, 15), new t(46, 16))),
            new r(34, new Array(6, 34, 62, 90, 118, 146), new n(30, new t(13, 115), new t(6, 116)), new n(28, new t(14, 46), new t(23, 47)), new n(30, new t(44, 24), new t(7, 25)), new n(30, new t(59, 16), new t(1, 17))),
            new r(35, new Array(6, 30, 54, 78, 102, 126, 150), new n(30, new t(12, 121), new t(7, 122)), new n(28, new t(12, 47), new t(26, 48)), new n(30, new t(39, 24), new t(14, 25)), new n(30, new t(22, 15), new t(41, 16))),
            new r(36, new Array(6, 24, 50, 76, 102, 128, 154), new n(30, new t(6, 121), new t(14, 122)), new n(28, new t(6, 47), new t(34, 48)), new n(30, new t(46, 24), new t(10, 25)), new n(30, new t(2, 15), new t(64, 16))),
            new r(37, new Array(6, 28, 54, 80, 106, 132, 158), new n(30, new t(17, 122), new t(4, 123)), new n(28, new t(29, 46), new t(14, 47)), new n(30, new t(49, 24), new t(10, 25)), new n(30, new t(24, 15), new t(46, 16))),
            new r(38, new Array(6, 32, 58, 84, 110, 136, 162), new n(30, new t(4, 122), new t(18, 123)), new n(28, new t(13, 46), new t(32, 47)), new n(30, new t(48, 24), new t(14, 25)), new n(30, new t(42, 15), new t(32, 16))),
            new r(39, new Array(6, 26, 54, 82, 110, 138, 166), new n(30, new t(20, 117), new t(4, 118)), new n(28, new t(40, 47), new t(7, 48)), new n(30, new t(43, 24), new t(22, 25)), new n(30, new t(10, 15), new t(67, 16))),
            new r(40, new Array(6, 30, 58, 86, 114, 142, 170), new n(30, new t(19, 118), new t(6, 119)), new n(28, new t(18, 47), new t(31, 48)), new n(30, new t(34, 24), new t(34, 25)), new n(30, new t(20, 15), new t(61, 16)))
        )),
        ...
        (i.quadrilateralToQuadrilateral = function (e, t, n, r, i, a, o, s, h, w, f, u, d, l, c, g) {
        ...
        (i.squareToQuadrilateral = function (e, t, n, r, a, o, s, h) {
            var w = h - o,
                f = t - r + o - h;
            if (0 == w && 0 == f) return new i(n - e, a - n, e, r - t, o - r, t, 0, 0, 1);
            var u = n - a,
                d = s - a,
                l = e - n + a - s,
                c = r - o,
                ...
                v = (l * w - d * f) / g,
                m = (u * f - l * c) / g;
            return new i(n - e + v * n, s - e + m * s, e, r - t + v * r, h - t + m * h, t, v, m, 1);
        }),
    ...
    (w.numBitsDiffering = function (e, t) {
        return h[15 & (e ^= t)] + h[15 & M(e, 4)] + h[15 & M(e, 8)] + h[15 & M(e, 12)] + h[15 & M(e, 16)] + h[15 & M(e, 20)] + h[15 & M(e, 24)] + h[15 & M(e, 28)];
    }),
    ...
    function v(e, t) {
        ...
        this.__defineGetter__("Width", function () {
            ...
            (this.setRegion = function (e, t, n, r) {
                ...
                var i = e + n,
                    a = t + r;
                if (a > this.height || i > this.width) throw "The region must fit inside the matrix";
                for (var o = t; o < a; o++) for (var s = o * this.rowSize, h = e; h < i; h++) this.bits[s + (h >> 5)] |= 1 << (31 & h);
            });
    }
    function m(e, t) {
    ...
    function b(e) {
        ...
        (this.bitMatrix = e),
            ...
            (this.readFormatInformation = function () {
                ...
                if (((this.parsedFormatInfo = w.decodeFormatInformation(e)), null != this.parsedFormatInfo)) return this.parsedFormatInfo;
            ...
            (this.readVersion = function () {
                ...
                n = 0;
                for (o = 5; o >= 0; o--) for (a = e - 9; a >= i; a--) n = this.copyBit(o, a, n);
                if (((this.parsedVersion = r.decodeVersionInformation(n)), null != this.parsedVersion && this.parsedVersion.DimensionForVersion == e)) return this.parsedVersion;
            ...
            (this.readCodewords = function () {
                ...
                for (var i = t.buildFunctionPattern(), a = !0, o = new Array(t.TotalCodewords), s = 0, h = 0, w = 0, f = r - 1; f > 0; f -= 2) {
                    6 == f && f--;
                    for (var u = 0; u < r; u++) for (var d = a ? r - 1 - u : u, l = 0; l < 2; l++) i.get_Renamed(f - l, d) || (w++, (h <<= 1), this.bitMatrix.get_Renamed(f - l, d) && (h |= 1), 8 == w && ((o[s++] = h), (w = 0), (h = 0)));
                    a ^= !0;
                }
    ...
    m.getDataBlocks = function (e, t, n) {
        ...
        for (var r = t.getECBlocksForLevel(n), i = 0, a = r.getECBlocks(), o = 0; o < a.length; o++) i += a[o].Count;
    ...
    function C(e, t) {
        ...
        if (n > 1 && 0 == t[0]) {
            ...
            if (r == n) this.coefficients = e.Zero.coefficients;
                ...
                for (var a = 0; a < this.coefficients.length; a++) this.coefficients[a] = t[r + a];
            }
        ...
        this.__defineGetter__("Zero", function () {
            ...
            (this.evaluateAt = function (e) {
                ...
                if (1 == e) {
                    for (var n = 0, r = 0; r < t; r++) n = _.addOrSubtract(n, this.coefficients[r]);
                    return n;
                }
                var i = this.coefficients[0];
                for (r = 1; r < t; r++) i = _.addOrSubtract(this.field.multiply(e, i), this.coefficients[r]);
                return i;
            }),
            (this.addOrSubtract = function (t) {
                ...
                for (var a = new Array(r.length), o = r.length - n.length, s = 0; s < o; s++) a[s] = r[s];
                for (var h = o; h < r.length; h++) a[h] = _.addOrSubtract(n[h - o], r[h]);
                return new C(e, a);
            }),
            (this.multiply1 = function (e) {
                ...
                for (var t = this.coefficients, n = t.length, r = e.coefficients, i = r.length, a = new Array(n + i - 1), o = 0; o < n; o++)
                    for (var s = t[o], h = 0; h < i; h++) a[o + h] = _.addOrSubtract(a[o + h], this.field.multiply(s, r[h]));
    ...
    (p.rsDecoder = new (function (e) {
        (this.field = e),
            (this.decode = function (e, t) {
                for (var n = new C(this.field, e), r = new Array(t), i = 0; i < r.length; i++) r[i] = 0;
                var a = !0;
                for (i = 0; i < t; i++) {
                ...
                if (!a) {
                    var s = new C(this.field, r),
                        h = this.runEuclideanAlgorithm(this.field.buildMonomial(t, 1), s, t),
                        w = h[0],
                        f = h[1],
            ...
            (this.runEuclideanAlgorithm = function (e, t, n) {
                ...
                for (var i = e, a = t, o = this.field.One, s = this.field.Zero, h = this.field.Zero, w = this.field.One; a.Degree >= Math.floor(n / 2); ) {
                    var f = i,
                        u = o,
                        d = h;
                    if (((o = s), (h = w), (i = a).Zero)) throw "r_{i-1} was zero";
                    a = f;
                    for (var l = this.field.Zero, c = i.getCoefficient(i.Degree), g = this.field.inverse(c); a.Degree >= i.Degree && !a.Zero; ) {
                        var v = a.Degree - i.Degree,
                            m = this.field.multiply(a.getCoefficient(a.Degree), g);
                        (l = l.addOrSubtract(this.field.buildMonomial(v, m))), (a = a.addOrSubtract(i.multiplyByMonomial(v, m)));
                    }
                    (s = l.multiply1(o).addOrSubtract(u)), (w = l.multiply1(h).addOrSubtract(d));
                }
            ...
            (this.findErrorMagnitudes = function (e, t, n) {
                for (var r = t.length, i = new Array(r), a = 0; a < r; a++) {
                    for (var o = this.field.inverse(t[a]), s = 1, h = 0; h < r; h++) a != h && (s = this.field.multiply(s, _.addOrSubtract(1, this.field.multiply(t[h], o))));
                    (i[a] = this.field.multiply(e.evaluateAt(o), this.field.inverse(s))), n && (i[a] = this.field.multiply(i[a], o));
                }
                return i;
            });
    })(_.QR_CODE_FIELD)),
        ...
        (p.decode = function (e) {
            for (var t = new b(e), n = t.readVersion(), r = t.readFormatInformation().ErrorCorrectionLevel, i = t.readCodewords(), a = m.getDataBlocks(i, n, r), o = 0, s = 0; s < a.length; s++) o += a[s].NumDataCodewords;
    ...
    (A.imagedata = null),
        ...
        (A.vidSuccess = function (e) {
            (A.localstream = e),
                A.webkit ? (A.video.src = window.webkitURL.createObjectURL(e)) : A.moz ? ((A.video.mozSrcObject = e), A.video.play()) : (A.video.src = e),
                (A.gUM = !0),
        ...
        (A.captureToCanvas = function () {
            if (A.gUM)
                try {
                    if (0 == A.video.videoWidth) return void setTimeout(A.captureToCanvas, 500);
                    (A.canvas_qr2.width = A.video.videoWidth), (A.canvas_qr2.height = A.video.videoHeight), A.qrcontext2.drawImage(A.video, 0, 0);
                    try {
                        A.decode();
                    } catch (e) {
        ...
        (A.setWebcam = function (e) {
                ...
                try {
                    navigator.mediaDevices.enumerateDevices().then(function (e) {
                        e.forEach(function (e) {
                            console.log("deb1"), "videoinput" === e.kind && e.label.toLowerCase().search("back") > -1 && (n = [{ sourceId: e.deviceId }]), console.log(e.kind + ": " + e.label + " id = " + e.deviceId);
                        });
                    });
                } catch (e) {
                    console.log(e);
            ...
            t.getUserMedia
                ? t.getUserMedia({ video: n, audio: !1 }, A.vidSuccess, A.vidError)
                : t.webkitGetUserMedia
                ? ((A.webkit = !0), t.webkitGetUserMedia({ video: n, audio: !1 }, A.vidSuccess, A.vidError))
                : t.mozGetUserMedia && ((A.moz = !0), t.mozGetUserMedia({ video: n, audio: !1 }, A.vidSuccess, A.vidError));
        }),
        (A.decode = function (e) {
            ...
            (r.crossOrigin = "Anonymous"),
                (r.onload = function () {
                    ...
                    (n.width = o), (n.height = a), i.drawImage(r, 0, 0, n.width, n.height), (A.width = n.width), (A.height = n.height);
                    try {
                        A.imagedata = i.getImageData(0, 0, n.width, n.height);
                    } catch (e) {
                        return (A.result = "Cross domain image reading not supported in your browser! Save it to your computer then drag and drop the file!"), void (null != A.callback && A.callback(A.result));
                    }
                    try {
            ...
            if (A.debug) {
                for (var r = 0; r < A.height; r++)
                    for (var i = 0; i < A.width; i++) {
                        ...
                        (A.imagedata.data[a] = (n[i + r * A.width], 0)), (A.imagedata.data[a + 1] = (n[i + r * A.width], 0)), (A.imagedata.data[a + 2] = n[i + r * A.width] ? 255 : 0);
                    }
            ...
            if (A.debug) {
                for (r = 0; r < s.bits.Height; r++)
                    for (i = 0; i < s.bits.Width; i++) {
                        ...
                        (A.imagedata.data[a] = (s.bits.get_Renamed(i, r), 0)), (A.imagedata.data[a + 1] = (s.bits.get_Renamed(i, r), 0)), (A.imagedata.data[a + 2] = s.bits.get_Renamed(i, r) ? 255 : 0);
                    }
                e.putImageData(A.imagedata, 0, 0);
            }
            for (var h = p.decode(s.bits).DataByte, w = "", f = 0; f < h.length; f++) for (var u = 0; u < h[f].length; u++) w += String.fromCharCode(h[f][u]);
        ...
        (A.getPixel = function (e, t) {
            ...
            return (33 * A.imagedata.data[n] + 34 * A.imagedata.data[n + 1] + 33 * A.imagedata.data[n + 2]) / 100;
        }),
        ...
        (A.getMiddleBrightnessPerArea = function (e) {
            for (var t = Math.floor(A.width / 4), n = Math.floor(A.height / 4), r = new Array(4), i = 0; i < 4; i++) {
                r[i] = new Array(4);
                ...
                for (var s = 0; s < 4; s++) {
                    ...
                    for (var h = 0; h < n; h++)
                        for (var w = 0; w < t; w++) {
                            ...
                            f < r[s][o][0] && (r[s][o][0] = f), f > r[s][o][1] && (r[s][o][1] = f);
                        }
                }
            for (var u = new Array(4), d = 0; d < 4; d++) u[d] = new Array(4);
            for (o = 0; o < 4; o++) for (s = 0; s < 4; s++) u[s][o] = Math.floor((r[s][o][0] + r[s][o][1]) / 2);
            return u;
        }),
        (A.grayScaleToBitmap = function (e) {
            for (var t = A.getMiddleBrightnessPerArea(e), n = t.length, r = Math.floor(A.width / n), i = Math.floor(A.height / n), a = new ArrayBuffer(A.width * A.height), o = new Uint8Array(a), s = 0; s < n; s++)
                for (var h = 0; h < n; h++) for (var w = 0; w < i; w++) for (var f = 0; f < r; f++) o[r * h + f + (i * s + w) * A.width] = e[r * h + f + (i * s + w) * A.width] < t[h][s];
            return o;
        }),
        (A.grayscale = function () {
            for (var e = new ArrayBuffer(A.width * A.height), t = new Uint8Array(e), n = 0; n < A.height; n++)
                for (var r = 0; r < A.width; r++) {
                    var i = A.getPixel(r, n);
                    t[r + n * A.width] = i;
                }
        ...
        (this.image = null),
            ...
            (this.foundPatternCross = function (e) {
                ...
                var i = Math.floor((t << S) / 7),
                    a = Math.floor(i / 2);
                return Math.abs(i - (e[0] << S)) < a && Math.abs(i - (e[1] << S)) < a && Math.abs(3 * i - (e[2] << S)) < 3 * a && Math.abs(i - (e[3] << S)) < a && Math.abs(i - (e[4] << S)) < a;
            }),
            (this.centerFromEnd = function (e, t) {
                return t - e[4] - e[3] - e[2] / 2;
            }),
            (this.crossCheckVertical = function (e, t, n, r) {
                for (var i = this.image, a = A.height, o = this.CrossCheckStateCount, s = e; s >= 0 && i[t + s * A.width]; ) o[2]++, s--;
                if (s < 0) return NaN;
                ...
                return 5 * Math.abs(h - r) >= 2 * r ? NaN : this.foundPatternCross(o) ? this.centerFromEnd(o, s) : NaN;
            }),
            (this.crossCheckHorizontal = function (e, t, n, r) {
                for (var i = this.image, a = A.width, o = this.CrossCheckStateCount, s = e; s >= 0 && i[s + t * A.width]; ) o[2]++, s--;
                if (s < 0) return NaN;
                ...
                if (o[4] >= n) return NaN;
                var h = o[0] + o[1] + o[2] + o[3] + o[4];
                return 5 * Math.abs(h - r) >= r ? NaN : this.foundPatternCross(o) ? this.centerFromEnd(o, s) : NaN;
            }),
            (this.handlePossibleCenter = function (e, t, n) {
                ...
                if (!isNaN(a) && ((i = this.crossCheckHorizontal(Math.floor(i), Math.floor(a), e[2], r)), !isNaN(i))) {
                    for (var o = r / 7, s = !1, h = this.possibleCenters.length, w = 0; w < h; w++) {
            ...
            (this.selectBestPatterns = function () {
                ...
                if (e < 3) throw "Couldn't find enough finder patterns (found " + e + ")";
                if (e > 3) {
                    ...
                    for (r = this.possibleCenters.length - 1; r >= 0; r--) {
                        ...
                        Math.abs(h.EstimatedModuleSize - a) > s && this.possibleCenters.splice(r, 1);
                    }
                }
                return (
            ...
            (this.haveMultiplyConfirmedCenters = function () {
                ...
                var a = t / n,
                    o = 0;
                for (r = 0; r < n; r++) (i = this.possibleCenters[r]), (o += Math.abs(i.EstimatedModuleSize - a));
                return o <= 0.05 * t;
            }),
                        ...
                        if (e[h + o * A.width]) 1 == (1 & s) && s++, a[s]++;
                            ...
                            if (4 == s)
                                if (this.foundPatternCross(a)) {
                                    ...
                                    (s = 0), (a[0] = 0), (a[1] = 0), (a[2] = 0), (a[3] = 0), (a[4] = 0);
                                } else (a[0] = a[2]), (a[1] = a[3]), (a[2] = a[4]), (a[3] = 1), (a[4] = 0), (s = 3);
                            else a[++s]++;
                        else a[s]++;
                    if (this.foundPatternCross(a)) this.handlePossibleCenter(a, o, n) && ((r = a[0]), this.hasSkipped && (i = this.haveMultiplyConfirmedCenters()));
                }
    ...
    function F(e, t, n, r, i, a, o) {
        (this.image = e),
            ...
            (this.foundPatternCross = function (e) {
                for (var t = this.moduleSize, n = t / 2, r = 0; r < 3; r++) if (Math.abs(t - e[r]) >= n) return !1;
                return !0;
            }),
            (this.crossCheckVertical = function (e, t, n, r) {
                var i = this.image,
                ...
                (o[0] = 0), (o[1] = 0), (o[2] = 0);
                for (var s = e; s >= 0 && i[t + s * A.width] && o[1] <= n; ) o[1]++, s--;
                if (s < 0 || o[1] > n) return NaN;
                for (; s >= 0 && !i[t + s * A.width] && o[0] <= n; ) o[0]++, s--;
                if (o[0] > n) return NaN;
            ...
            (this.handlePossibleCenter = function (e, t, n) {
                ...
                if (!isNaN(a)) {
                    for (var o = (e[0] + e[1] + e[2]) / 3, s = this.possibleCenters.length, h = 0; h < s; h++) {
                        if (this.possibleCenters[h].aboutEquals(o, a, i)) return new x(i, a, o);
                    }
                    var w = new x(i, a, o);
            ...
            (this.find = function () {
                for (var t = this.startX, i = this.height, a = t + r, o = n + (i >> 1), s = new Array(0, 0, 0), h = 0; h < i; h++) {
                    ...
                    for (var u = 0; f < a; ) {
                        if (e[f + w * A.width])
                            if (1 == u) s[u]++;
                                ...
                                var d;
                                if (this.foundPatternCross(s)) if (null != (d = this.handlePossibleCenter(s, w, f))) return d;
                                (s[0] = s[2]), (s[1] = 1), (s[2] = 0), (u = 1);
                            } else s[++u]++;
                        else 1 == u && u++, s[u]++;
                        f++;
                    }
                    if (this.foundPatternCross(s)) if (null != (d = this.handlePossibleCenter(s, w, a))) return d;
                }
        ...
        (this.blockPointer = 0),
            ...
            (this.getNextBits = function (e) {
                ...
                if (e < this.bitPointer + 1 + 8) {
                    ...
                    return (
                        (t = (this.blocks[this.blockPointer] & i) << (e - (this.bitPointer + 1))),
                        this.blockPointer++,
                ...
                if (e < this.bitPointer + 1 + 16) {
                    ...
                    return (
                        ...
                        (t = o + s + ((this.blocks[this.blockPointer] & a) >> (8 - (e - (this.bitPointer + 1 + 8))))),
            ...
            (this.getKanjiString = function (e) {
                ...
                do {
                    var i = (((n = this.getNextBits(13)) / 192) << 8) + (n % 192),
                        a = 0;
                    (a = i + 33088 <= 40956 ? i + 33088 : i + 49472), (r += String.fromCharCode(a)), t--;
                } while (t > 0);
                return r;
            }),
            ...
            this.__defineGetter__("DataByte", function () {
                for (var e = new Array(); ; ) {
                    ...
                    if (7 == t) var n = this.parseECIValue();
                        ...
                        switch (t) {
                            case 1:
                                for (var i = this.getFigureString(r), a = new Array(i.length), o = 0; o < i.length; o++) a[o] = i.charCodeAt(o);
                                e.push(a);
                                break;
                            case 2:
                                for (i = this.getRomanAndFigureString(r), a = new Array(i.length), o = 0; o < i.length; o++) a[o] = i.charCodeAt(o);
                                e.push(a);
                                break;
                            case 4:
    ...
    return (
        (A.orderBestPatterns = function (e) {
            ...
            var n,
                ...
                s = t(e[0], e[2]);
            if (
                (o >= a && o >= s ? ((r = e[0]), (n = e[1]), (i = e[2])) : s >= o && s >= a ? ((r = e[1]), (n = e[0]), (i = e[2])) : ((r = e[2]), (n = e[0]), (i = e[1])),
                (function (e, t, n) {
                    var r = t.x,
                        i = t.y;
...
var Html5Qrcode = (function () {
    function a(b, c) {
        if ((_classCallCheck(this, a), !getLazarSoftScanner)) throw "Use html5qrcode.min.js without edit, getLazarSoftScannernot found.";
        if (((this.qrcode = getLazarSoftScanner()), !this.qrcode)) throw "qrcode is not defined, use the minified/html5-qrcode.min.js for proper support";
        (this._elementId = b),
            ...
            [
                {
                    ...
                    value: function (b, c, d, e) {
                        ...
                        var i = !1;
                        h.videoConstraints && (this._isMediaStreamConstraintsValid(h.videoConstraints) ? (i = !0) : a._logError("'videoConstraints' is not valid 'MediaStreamConstraints, it will be ignored.'", !0));
                        var j = i,
                            k = null != h.qrbox,
                            l = document.getElementById(this._elementId),
                            m = l.clientWidth ? l.clientWidth : a.DEFAULT_WIDTH;
                        if (((l.style.position = "relative"), (this._shouldScan = !0), (this._element = l), (this.qrcode.callback = d), k)) {
                            var n = h.qrbox;
                            if (n < a.MIN_QR_BOX_SIZE) throw "minimum size of 'config.qrbox' is" + " ".concat(a.MIN_QR_BOX_SIZE, "px.");
                        ...
                        var o = function (a, b) {
                            ...
                            p = function () {
                                try {
                                    ...
                                    return f._possiblyUpdateShaders(!1), e("QR code parse error, error = ".concat(a)), !1;
                                }
                            },
                            q = function b() {
                                if (g._shouldScan) {
                                    if (g._localMediaStream) {
                                        var c = g._videoElement,
                                            ...
                                            k = g._qrRegion.x * d,
                                            l = g._qrRegion.y * e;
                                        g._context.drawImage(g._videoElement, k, l, i, j, 0, 0, g._qrRegion.width, g._qrRegion.height),
                                            p() || !0 === h.disableFlip || (f._context.translate(f._context.canvas.width, 0), f._context.scale(-1, 1), p());
                                    }
                                ...
                                return new Promise(function (b, c) {
                                    ...
                                    if (((g._localMediaStream = a), j || !h.aspectRatio)) d();
                                        ...
                                        i.applyConstraints(e)
                                            ...
                                            ["catch"](function (a) {
                                                console.log("[Warning] [Html5Qrcode] Constriants could not be satisfied, ignoring constraints", a), d();
                                            });
                                    }
                                });
                            };
                        return new Promise(function (a, c) {
                            if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
                                ...
                                if ("string" != typeof b) throw "The device doesn't support navigator.mediaDevices, only supported cameraIdOrConfig in this case is deviceId parameter (string).";
                ...
                },
                {
                    ...
                    value: function () {
                        if (null == this._localMediaStream) throw "Scanning is not in running state, call this API only when QR code scanning using camera is in running state.";
                        if (0 == this._localMediaStream.getVideoTracks().length) throw "No video tracks found";
                ...
                },
                {
                    ...
                    value: function (a) {
                        ...
                        else if (!this._isMediaStreamConstraintsValid(a)) throw "invalid videoConstaints passed, check logs for more details";
                        if (null == this._localMediaStream) throw "Scanning is not in running state, call this API only when QR code scanning using camera is in running state.";
                        if (0 == this._localMediaStream.getVideoTracks().length) throw "No video tracks found";
                        return new Promise(function (c, d) {
                            if ("aspectRatio" in a) return void d("Chaning 'aspectRatio' in run-time is not yet supported.");
                    ...
                    value: function (b, c, d, e) {
                        if (!(1 > c - e || 1 > d - e)) {
                            ...
                            if (
                                ...
                                (f.style.borderLeft = "".concat((c - e) / 2, "px solid #0000007a")),
                                (f.style.borderRight = "".concat((c - e) / 2, "px solid #0000007a")),
                                (f.style.borderTop = "".concat((d - e) / 2, "px solid #0000007a")),
                                (f.style.borderBottom = "".concat((d - e) / 2, "px solid #0000007a")),
                ...
                },
                {
                    ...
                    value: function (b, c, d, e, f, g) {
                        ...
                        (h.style.position = "absolute"),
                            ...
                            g ? (h.style.left = "".concat(f, "px")) : (h.style.right = "".concat(f, "px")),
                ...
                },
                {
                    ...
                    value: function (a) {
                        ...
                        if ("object" == _typeof(a)) {
                            var b = { environment: !0, environment: !0 },
                                c = function (a) {
                                    if (a in b) return !0;
                                    throw "config has invalid 'facingMode' value = " + "'".concat(a, "'");
                                },
                                d = Object.keys(a);
                            if (1 != d.length) throw "'cameraIdOrConfig' object should have exactly 1 key," + " if passed as an object, found ".concat(d.length, " keys");
                            var e = Object.keys(a)[0];
                            if ("facingMode" != e && "deviceId" != e) throw "Only '".concat("facingMode", "' and '").concat("deviceId", "' ") + " are supported for 'cameraIdOrConfig'";
                            if ("facingMode" == e) {
                                var f = a[e];
                                if ("string" == typeof f) {
                                ...
                                } else if (!("exact" in f)) throw "'facingMode' should be string or object with" + " ".concat("exact", " as key.");
                ...
                },
                {
                    ...
                    value: function (b) {
                        ...
                        if ("object" !== _typeof(b)) {
                            var c = _typeof(b);
                            return a._logError("videoConstraints should be of type object, the " + "object passed is of type ".concat(c, "."), !0), !1;
                        }
                        for (var d, e = ["autoGainControl", "channelCount", "echoCancellation", "latency", "noiseSuppression", "sampleRate", "sampleSize", "volume"], f = new Set(e), g = Object.keys(b), h = 0; h < g.length; h++)
                    ...
                    value: function () {
                        ...
                        return new Promise(function (b, c) {
                            if (navigator.mediaDevices && navigator.mediaDevices.enumerateDevices && navigator.mediaDevices.getUserMedia)
                                    ...
                                    navigator.mediaDevices
                                        ...
                                        .then(function (d) {
                                            ...
                                            navigator.mediaDevices
                                                .enumerateDevices()
                                                .then(function (c) {
                                                    for (var f, g = [], h = 0; h < c.length; h++) (f = c[h]), "videoinput" == f.kind && g.push({ id: f.deviceId, label: f.label });
                                ...
                                var d = function (c) {
                                    for (var d, e = [], f = 0; f !== c.length; ++f) (d = c[f]), "video" === d.kind && e.push({ id: d.id, label: d.label });
        ...
        _createClass(a, [
            ...
            },
            {
                ...
                value: function (a) {
                    ...
                    (b.id = c), (b.style.width = "100%"), (b.style.minHeight = "100px"), (b.style.textAlign = "center"), a.appendChild(b), this.__insertCameraScanImageToScanRegion();
                        ...
                        i.addEventListener("change", function (c) {
                            if (b.currentScanType === a.SCAN_TYPE_FILE && 0 != c.target.files.length) {
                                ...
                                b.html5Qrcode
                                    ...
                                    ["catch"](function (c) {
                                        b.__setStatus("ERROR", a.STATUS_WARNING), b.__setHeaderMessage(c, a.STATUS_WARNING), b.qrCodeErrorCallback(c);
                                    });
                            }
                        });
                },
                    ...
                    (g.style.textDecoration = "underline"),
                        ...
                        g.addEventListener("click", function () {
                            return b.sectionSwapAllowed
                                ...
                                : void (b.verbose && console.error("Section swap called when not allowed"));
                        }),
                        f.appendChild(g),
                        e.appendChild(f);
                },
